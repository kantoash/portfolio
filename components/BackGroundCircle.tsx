...
function BackGroundCircle({}: Props) {
  return (
    ...
    >
      ...
      <div className=" h-[300px] w-[300px] absolute border border-[#333333] rounded-full mt-52 "></div>
      <div className=" h-[500px] w-[500px] absolute border border-[#333333] rounded-full mt-52 "></div>
